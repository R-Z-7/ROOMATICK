...
import { CheckSquare, Home, Calendar, History, Users, Settings, LogOut, Menu, X } from "lucide-react";
          ...
          {mobileDrawerOpen && (
            <div className="md:hidden fixed inset-0 z-50 flex">
              <div
                ...
                aria-hidden="true"
              />
              <div className="relative ml-auto w-72 max-w-[85vw] bg-white dark:bg-zinc-900 border-l border-zinc-200 dark:border-zinc-800 flex flex-col">
