...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar bg-background p-2 [--cell-radius:0.375rem] [--cell-size:1.75rem] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
      ...
      classNames={{
        ...
        day: cn(
          ...
          props.showWeekNumber
            ? "[&_nth-child(2)[data-selected=true]_button]:rounded-l-[var(--cell-radius)]"
            : "[&_first-child[data-selected=true]_button]:rounded-l-[var(--cell-radius)]",
